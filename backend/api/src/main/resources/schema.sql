...
SELECT '00000000-0000-0000-0000-000000000001', '2026-DEM-01', 'Operational planning demonstration', 'HU', 'Budapest', 'Europe/Budapest', DATE '2026-10-12', DATE '2026-10-16', 'OPEN_FOR_NOMINATION', 'WORK_PROGRAMME', 'am.alex', 'po.petra,ia.ines' WHERE NOT EXISTS (SELECT 1 FROM activity WHERE course_reference = '2026-DEM-01');
INSERT INTO activity (id, course_reference, title, country_code, venue, time_zone, starts_on, ends_on, status, funding_regime, am_username, support_usernames)
SELECT '00000000-0000-0000-0000-000000000002', '2026-DEM-02', 'Cross-border service planning', 'BE', 'Brussels', 'Europe/Brussels', DATE '2026-11-02', DATE '2026-11-04', 'DRAFT', 'CONTRIBUTION_AGREEMENT', 'am.alex', 'ia.ines' WHERE NOT EXISTS (SELECT 1 FROM activity WHERE course_reference = '2026-DEM-02');
